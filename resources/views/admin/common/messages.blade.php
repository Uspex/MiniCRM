...
<div id="js-response-success" class="alert alert-fill alert-success alert-icon ">
    <em class="icon ni ni-check-circle"></em> <strong>{{ __('Success') }}</strong>. <span class="message"></span> <button class="close" data-dismiss="alert"></button>
</div>
