                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">{{ __('activity.form.create_title') }}</h3>
                            </div>
                            <div class="nk-block-head-content">
                                                        ...
                                                        <div class="row g-4">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="plan_quantity" value="{{ old('plan_quantity') }}"
                                                                           id="plan_quantity"
                                                                           type="number"
                                                                           min="0"
                                                                           class="form-control">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="plan_time" value="{{ old('plan_time') }}"
                                                                           id="plan_time"
                                                                           type="number"
                                                                           min="0"
                                                                           step="0.01"
